...
func NewService(
	...
	apiRouter.HandleFunc("/projects/{project}/devices/{device}/connection", s.initWith(s.withDeviceAuth, s.withHijackedWebSocketConnection)(s.initiateDeviceConnection)).Methods("GET")
	apiRouter.HandleFunc("/projects/{project}/devices/{device}/submitstats", s.initWith(s.withDeviceAuth)(s.submitStats)).Methods("POST")
